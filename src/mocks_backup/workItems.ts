...
function seedToItem(s: ItemSeed, idx: number): WorkItem {
  ...
  return {
    ...
    ...(needsVerification && !s.executionResult ? { executionResult: 'completed' as const, integrityResult: 'match' as const } : {}),
